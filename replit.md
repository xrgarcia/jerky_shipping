...
- **Core Features**:
    ...
    - **Shipments Page**: Displays all shipments with proper SQL LEFT JOIN to orders table, handling shipments without order linkage gracefully. Includes orphaned shipment detection and advanced filters.
