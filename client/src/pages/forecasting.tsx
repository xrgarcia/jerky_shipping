                      ...
                      <span className="inline-flex items-center gap-1 justify-end">
                        {col.tooltip && (
                          <HoverTooltip>
                            ...
                            <HoverTooltipContent side="top" className="max-w-[240px] normal-case font-normal tracking-normal" style={{ fontSize: '0.75rem', lineHeight: '1.4', color: 'hsl(var(--popover-foreground))', textAlign: 'left' }}>
                              {col.tooltip}
                            </HoverTooltipContent>
                          </HoverTooltip>
                        )}
